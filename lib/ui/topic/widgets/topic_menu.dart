...
class TopicMenu extends StatelessWidget {
  ...
  TopicMenu({Key key, this.categoryUid, this.partUid, this.part, this.topicUid, this.topic, this.itemDatasBloc}) : super(key: key);
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              ItemsMenu(categoryUid: categoryUid, partUid: partUid, topicUid: topicUid, topic: topic, itemDatasBloc: itemDatasBloc,),
              Container(
